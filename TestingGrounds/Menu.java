public class Menu {
    ...
    public Menu() {
        ...
        drinks = new Drink[3];
        // All drinks are soft drinks sold by bottle - same price
        drinks[0] = new Drink("RC Cola (bottle)", 20);
        drinks[1] = new Drink("Coke (bottle)", 20);
        drinks[2] = new Drink("Royal (bottle)", 20);
    }
